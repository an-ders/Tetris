class I{
    constructor (tileSize){
        ...
        this.tiles = [];
        for (let i = 0; i < 4; i++){
            this.tiles.push([this.x + i, this.y])
        }
    }
    ...
    rotateCW(board){
        const OFFSETS_0 = [[0,0],[1,0],[-2,0],[1,-2],[-2,1]];
        const OFFSETS_1 = [[0,0],[-2,0],[1,0],[-2,-1],[1,2]];
        const OFFSETS_2 = [[0,0],[-1,0],[2,0],[-1,-2],[2,-1]];
        const OFFSETS_3 = [[0,0],[2,0],[-1,0],[2,1],[-1,-2]];
        this.rotation++;
        if (this.rotation == 4)
            this.rotation = 0;
        var baseX;
        ...
        switch (this.rotation){//---------------------------------rotating the piece
            case 0:
                baseX = this.tiles[1][0];
                baseY = this.tiles[1][1];
                this.tiles[0] = [baseX-1, baseY];
                this.tiles[1] = [baseX, baseY];
                this.tiles[2] = [baseX+1, baseY];
                this.tiles[3] = [baseX+2, baseY];
                offsetGroup = OFFSETS_0;
                break;
            case 1:
                baseX = this.tiles[2][0];
                baseY = this.tiles[2][1];
                this.tiles[0] = [baseX, baseY-1];
                this.tiles[1] = [baseX, baseY];
                this.tiles[2] = [baseX, baseY+1];
                this.tiles[3] = [baseX, baseY+2];
                offsetGroup = OFFSETS_1;
                break;
            case 2:
                baseX = this.tiles[2][0];
                baseY = this.tiles[2][1];
                this.tiles[0] = [baseX-2, baseY];
                this.tiles[1] = [baseX-1, baseY];
                this.tiles[2] = [baseX, baseY];
                this.tiles[3] = [baseX+1, baseY];
                offsetGroup = OFFSETS_2;
                break;
            case 3:
                baseX = this.tiles[1][0];
                baseY = this.tiles[1][1];
                this.tiles[0] = [baseX, baseY-2];
    ...
    rotateCCW(board){
        const OFFSETS_0 = [[0,0],[2,0],[-1,0],[2,1],[-1,-2]];
        const OFFSETS_1 = [[0,0],[1,0],[-2,0],[1,-2],[-2,1]];
        const OFFSETS_2 = [[0,0],[-2,0],[1,0],[-2,-1],[1,2]];
        const OFFSETS_3 = [[0,0],[-1,0],[2,0],[-1,2],[2,-1]];
        this.rotation--;
        if (this.rotation == -1)
            this.rotation = 3;
        var baseX;
